...
if(!isset($_SESSION["user_id"]) or $_GET["page"] == "login"){
    ...
    $lg = file_get_contents(".private/private/login.html");
    $response["content"] = $lg;
  ...
  <head>
    ...
    <style>
      body {
        ...
        .modal-content {
            background-color: rgba(255,255,255,0.80);/*rgba(249,249,249,1);*/
...
@font-face {
            ...
            src: url('fonts/YourCustomFont.otf') format('opentype'); /* Make sure this path is correct */
        }
